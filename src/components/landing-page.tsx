            ...
            <section id="services" className="mt-10 py-24 border-t border-gray-200 px-4 sm:px-6 lg:px-8">
              <div className="container mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-between mb-12">
                  <div className="flex items-center mb-4 md:mb-0"> {/* Added margin-bottom for mobile */}
                    <div className="w-12 h-12 bg-black rounded-full flex items-center justify-center mr-4">
                      <Building className="w-6 h-6 text-white" />
                    </div>
                    <h3 className="text-2xl sm:text-3xl font-semibold">OUR COMPREHENSIVE SERVICES</h3>
                  </div>
                  <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4"> {/* Added flex column on mobile */}
