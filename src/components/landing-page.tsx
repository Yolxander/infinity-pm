  ...
  return (
      <div className="flex flex-col min-h-screen bg-[#f5f5f5]">
        ...
        <main className="flex-grow pt-20">
          ...
          <ScrollAnimationWrapper>
            <div className="mt-6 relative py-16">
          ...
          <ScrollAnimationWrapper>
            <section className="mt-10 py-24 border-t border-gray-200">
          ...
          <ScrollAnimationWrapper>
            <section className="py-24 border-t border-gray-200 relative overflow-hidden">
